# Django settings for exifweb project.
...
SECRET_KEY = 'b4=ky1mttld&amp;31-i32=n-qm&amp;n*jdcg(2*nhr-h8lkd7p6w7j_4'
...
ROOT_URLCONF = 'exifweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'exifweb.wsgi.application'
